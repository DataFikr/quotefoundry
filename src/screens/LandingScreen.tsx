...
export function LandingScreen({ onStart, onLogin }: { onStart: () => void; onLogin: () => void }) {
  return (
    <div style={{ minHeight: '100vh', overflowY: 'auto', background: '#fff', color: color.ink, fontFamily: "'Source Sans 3', sans-serif" }} data-screen="landing">
      {/* nav */}
      <div style={{ position: 'sticky', top: 0, zIndex: 3, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 40px', background: 'rgba(255,255,255,.9)', backdropFilter: 'blur(8px)', borderBottom: `1px solid ${color.border}` }}>
      ...
      {/* hero */}
      <div style={{ background: `linear-gradient(180deg,${TINT},#F8FAFF)`, padding: '72px 40px 64px', textAlign: 'center' }}>
        <div style={{ fontFamily: heading, fontWeight: 700, fontSize: 13, color: ACCENT, letterSpacing: '.12em', marginBottom: 16 }}>BUILT FOR METAL FAB &amp; WELDING SHOPS</div>
        ...
        <p style={{ fontSize: 18, color: SUB, lineHeight: 1.55, maxWidth: 560, margin: '0 auto 30px' }}>Stop losing jobs to slow quotes and margin to forgotten costs. Enter the job, get a branded quote, win more work.</p>
        <div style={{ display: 'flex', gap: 14, justifyContent: 'center', alignItems: 'center', flexWrap: 'wrap' }}>
          <button onClick={onStart} style={{ fontFamily: heading, fontWeight: 700, fontSize: 16, padding: '15px 30px', borderRadius: 13, background: CTA, color: '#fff', border: 'none', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 9, boxShadow: `0 14px 28px -12px ${CTA}` }}>
            <i className="las la-arrow-right" style={{ fontSize: 19 }} />Quote your first job free
          </button>
          <button onClick={onLogin} style={{ fontFamily: heading, fontWeight: 700, fontSize: 15, padding: '15px 24px', borderRadius: 13, background: '#fff', color: ACCENT, border: `1.5px solid ${color.border}`, cursor: 'pointer' }}>Log in</button>
        </div>
        <div style={{ fontSize: 13.5, color: SUB, marginTop: 22, display: 'flex', gap: 22, justifyContent: 'center', flexWrap: 'wrap' }}>
      ...
      <div style={{ background: `linear-gradient(160deg,${color.panelFrom},${color.panelTo})`, padding: '58px 40px' }} data-testid="founding-beta">
        <div style={{ maxWidth: 860, margin: '0 auto', textAlign: 'center', color: '#fff' }}>
          ...
          <h2 style={{ fontFamily: heading, fontWeight: 900, fontSize: 30, margin: '0 0 12px', letterSpacing: '-.5px' }}>Free while we build it with you</h2>
          <p style={{ fontSize: 16.5, color: '#C7C8E0', lineHeight: 1.6, maxWidth: 640, margin: '0 auto 26px' }}>
          ...
          <div style={{ display: 'flex', gap: 18, justifyContent: 'center', flexWrap: 'wrap', fontSize: 14.5, color: '#C7C8E0', marginBottom: 28 }}>
          ...
          <button onClick={onStart} data-testid="beta-cta" style={{ fontFamily: heading, fontWeight: 700, fontSize: 15.5, padding: '14px 28px', borderRadius: 13, background: CTA, color: '#fff', border: 'none', cursor: 'pointer' }}>
      ...
      <div style={{ padding: '30px 40px', display: 'flex', alignItems: 'center', gap: 24, flexWrap: 'wrap', borderTop: `1px solid ${color.border}`, fontSize: 13.5, color: color.muted }}>
